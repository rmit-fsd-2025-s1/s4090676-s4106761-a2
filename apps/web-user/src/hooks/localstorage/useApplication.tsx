 ...
 */
export function useApplication(id: UUID): [Application | undefined, ((params: Partial<Application>) => void) | undefined] {
  ...
  return [
    application,
    application && ((newData: Partial<Application>) => setApplication({
      ...application,
      ...newData,
    })),
  ]
