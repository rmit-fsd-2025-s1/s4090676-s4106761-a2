...
export function TableRow ({
  ...
  const [tutor] = useUser(application.tutorId, AccountType.TUTOR) as [TutorAccount, undefined]
  ...
  return (
    <Row>
      ...
      <Table.Cell>{tutor?.availability ??
        <span style={{ textWrap: "nowrap" }}>N/A</span>}</Table.Cell>
