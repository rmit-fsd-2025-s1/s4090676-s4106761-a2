...
export function EditableNote ({ application }: { application: Application }): JSX.Element {
        ...
        <Editable.Input
          onBlur={(e) => {
            if (updateApplication) {
              ...
              toaster.create({
                description: "Unable to update user note at this time. Please try again later",
                type: "error",
              })
            }
          }}
